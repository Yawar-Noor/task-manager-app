...
function Auth() {
  ...
  return (
    <div className="w-full h-full sm:w-9/10 sm:h-9/10 flex items-center justify-center sm:gap-[8%] p-3 sm:border rounded-2xl">
      ...
      <div className="border border-zinc-400 w-9/10 sm:w-80 h-80 sm:h-90 min-w-55 flex flex-col gap-2 items-center justify-center p-3 rounded-2xl text-zinc-700 shadow-2xl">
        <input
          placeholder="Email..."
          className="mb-2 w-full border sm:text-sm font-mediun placeholder:font-normal  border-zinc-400 rounded-lg p-1 focus:drop-shadow-xl drop-shadow-black/30 outline-none"
          onChange={(e) => setEmail(e.target.value)}
        />
        <input
          type="password"
          placeholder="Password..."
          className="w-full border sm:text-sm font-mediun placeholder:font-normal border-zinc-400 rounded-lg p-1 mb-4 focus:drop-shadow-xl drop-shadow-black/30 outline-none"
